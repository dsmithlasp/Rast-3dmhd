...
C  The minimum # of processors in the z direction is 2 at the moment!
	PARAMETER(NPEY=8,NPEZ=8,NPE=NPEY*NPEZ)
      	PARAMETER(NPX=504,NPY=504,NPZ=2048)
C
...
C For 2D problem set NX<IX
	PARAMETER(NRY=NPY/NPEY)
        ...
        PARAMETER(NGRID=1)
	PARAMETER(XX1=-7.0D+00,XX2=7.0D+00)
	PARAMETER(YY1=-7.0D+00,YY2=7.0D+00)
	PARAMETER(ZZ1=-2.0D+00,ZZ2=1.0D-02)
        ...
        PARAMETER(IXCON=0,IYCON=0,IZCON=0,ITCON=1,IBCON=0)
